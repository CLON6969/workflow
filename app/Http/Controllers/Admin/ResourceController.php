...
public function create()
{
    ...
    return view('admin.resources.create', compact('boards'));
}
...
public function selectYear(ExamBoard $examBoard)
{
    ...
    return view('admin.resources.select-year', compact('examBoard', 'years'));
}
...
public function selectSession(ExamBoard $examBoard, BoardYear $boardYear)
{
    ...
    return view('admin.resources.select-session', compact(
...
public function selectProgram(ExamBoard $examBoard, BoardYear $boardYear, BoardSession $boardSession)
{
    ...
    return view('admin.resources.select-program', compact(
...
public function selectCourse(
    ...
    return view('admin.resources.select-course', compact(
        'examBoard',
        'boardYear',
        'boardSession',
        'boardProgram',
    ...
    public function uploadForm(
        ...
        return view('admin.resources.upload', compact(
            'examBoard',
            'boardYear',
            'boardSession',
            'boardProgram',
