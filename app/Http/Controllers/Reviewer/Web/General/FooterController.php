...
class FooterController extends Controller
{
    ...
    public function titleIndex()
    {
        ...
        return view('Reviewer.web.general.footer.titles.index', compact('titles'));
    }

    public function titleCreate()
    {
        return view('Reviewer.web.general.footer.titles.create');
    }
    ...
    public function titleStore(Request $request)
    {
        ...
        return redirect()->route('Reviewer.web.general.footer.titles.index')->with('success', 'Footer title created successfully.');
    }

    public function titleEdit(FooterTitle $title)
    {
        return view('Reviewer.web.general.footer.titles.edit', compact('title'));
    }
    ...
    public function titleUpdate(Request $request, FooterTitle $title)
    {
        ...
        return redirect()->route('Reviewer.web.general.footer.titles.index')->with('success', 'Footer title updated successfully.');
    }
    ...
    public function itemIndex()
    {
        ...
        return view('Reviewer.web.general.footer.items.index', compact('items'));
    }

    public function itemCreate()
    {
        $titles = FooterTitle::ordered()->get();
        return view('Reviewer.web.general.footer.items.create', compact('titles'));
    }
    ...
    public function itemStore(Request $request)
    {
        ...
        return redirect()->route('Reviewer.web.general.footer.items.index')->with('success', 'Footer item created successfully.');
    }

    public function itemEdit(FooterItem $item)
    {
        $titles = FooterTitle::ordered()->get();
        return view('Reviewer.web.general.footer.items.edit', compact('item', 'titles'));
    }
    ...
    public function itemUpdate(Request $request, FooterItem $item)
    {
        ...
        return redirect()->route('Reviewer.web.general.footer.items.index')->with('success', 'Footer item updated successfully.');
    }
