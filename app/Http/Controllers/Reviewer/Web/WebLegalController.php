...
class WebLegalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Reviewer.web.legal.index', compact('documents'));
    }
    ...
    public function create()
    {
        ...
        return view('Reviewer.web.legal.form', compact('document'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Reviewer.web.legal.index')->with('success', 'Legal document created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('Reviewer.web.legal.index')->with('success', 'Legal document updated successfully.');
    }
    ...
    public function destroy($id)
    {
        $document = LegalDocument::findOrFail($id);
        $document->delete();
        return redirect()->route('Reviewer.web.legal.index')->with('success', 'Legal document deleted successfully.');
    }
