...
class WebOpportunityController extends Controller
{
    public function index()
    {
        ...
        return view('Reviewer.web.opportunities.index', compact('opportunities'));
    }

    public function create()
    {
        return view('Reviewer.web.opportunities.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Reviewer.web.opportunities.index')->with('success', 'Opportunity created successfully.');
    }

    public function edit(Opportunity $opportunity)
    {
        return view('Reviewer.web.opportunities.edit', compact('opportunity'));
    }
    ...
    public function update(Request $request, Opportunity $opportunity)
    {
        ...
        return redirect()->route('Reviewer.web.opportunities.index')->with('success', 'Opportunity updated successfully.');
    }
    ...
    public function destroy(Opportunity $opportunity)
    {
        ...
        return redirect()->route('Reviewer.web.opportunities.index')->with('success', 'Opportunity deleted successfully.');
    }
}
