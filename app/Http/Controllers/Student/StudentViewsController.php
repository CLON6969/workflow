...
class StudentViewsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Student.home.index', compact(
            'examBoards',
            'logo',
            'resources',
            'trending',
    ...
    public function selectBoard()
    {
        ...
        return view('Student.home.select.board', compact('examBoards'));
    }
    ...
    public function selectYear(ExamBoard $examBoard)
    {
        ...
        return view('Student.home.select.year', compact('examBoard', 'years'));
    }
    ...
    public function selectSession(ExamBoard $examBoard, BoardYear $year)
    {
        ...
        return view('Student.home.select.session', compact('examBoard', 'year', 'sessions'));
    }
    ...
    public function selectProgram(ExamBoard $examBoard, BoardYear $year, BoardSession $session)
    {
        ...
        return view('Student.home.select.program', compact('examBoard', 'year', 'session', 'programs'));
    }
    ...
    public function selectCourse(ExamBoard $examBoard, BoardYear $year, BoardSession $session, BoardProgram $program)
    {
        ...
        return view('Student.home.select.course', compact(
            'examBoard',
            'year',
            'session',
            'program',
    ...
    ->toArray();
        ...
        return view('Student.home.resources.list', compact(
            'examBoard',
            'year',
            'session',
            'program',
...
public function saved()
{
    ...
    return view('Student.saved.index', compact('resources', 'savedIds'));
}
