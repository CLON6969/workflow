...
class UploaderViewsController extends Controller
{
    // ======================================================
    // HOME PAGE
    // ======================================================
    public function index(Request $request)
    {
        ...
        return view('Uploader.home.index', compact(
            'examBoards',
            'logo',
            'resources',
            'trending',
    ...
    public function selectBoard()
    {
        ...
        return view('Uploader.home.select.board', compact('examBoards'));
    }
    ...
    public function selectYear(ExamBoard $examBoard)
    {
        ...
        return view('Uploader.home.select.year', compact('examBoard', 'years'));
    }
    ...
    public function selectSession(ExamBoard $examBoard, BoardYear $year)
    {
        ...
        return view('Uploader.home.select.session', compact('examBoard', 'year', 'sessions'));
    }
    ...
    public function selectProgram(ExamBoard $examBoard, BoardYear $year, BoardSession $session)
    {
        ...
        return view('Uploader.home.select.program', compact('examBoard', 'year', 'session', 'programs'));
    }
    ...
    public function selectCourse(ExamBoard $examBoard, BoardYear $year, BoardSession $session, BoardProgram $program)
    {
        ...
        return view('Uploader.home.select.course', compact(
            'examBoard',
            'year',
            'session',
            'program',
    ...
    ->toArray();
        ...
        return view('Uploader.home.resources.list', compact(
            'examBoard',
            'year',
            'session',
            'program',
...
public function saved()
{
    ...
    return view('Uploader.saved.index', compact('resources', 'savedIds'));
}
