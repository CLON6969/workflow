...
<div class="container">
    ...
    <form action="{{ route('Reviewer.web.about.table.update', $table->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{ route('Reviewer.web.about.table.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
