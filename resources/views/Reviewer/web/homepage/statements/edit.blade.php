...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('Reviewer.web.homepage.statements.update', $statement->id) }}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <a href="{{ route('Reviewer.web.homepage.statements.index') }}" class="btn btn-secondary">Back</a>
            </form>
        </div>
    </div>
</div>
