...
<div class="container">
    <div class="buttons">
        <h4>Edit Record</h4>
        <a href="{{ route('Reviewer.web.homepage.table.index') }}" class="btn btn-secondary btn-sm">Back</a>
    </div>

    <form action="{{ route('Reviewer.web.homepage.table.update', $table->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
