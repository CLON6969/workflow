...
<div class="container">
    ...
    <form method="GET" action="{{ route('Reviewer.web.job.allPosts') }}" class="filters-form" aria-label="Filter job posts">
        <div style="display:flex; gap:1rem; flex-wrap:wrap; margin-bottom:1.5rem;">
            ...
            <a href="{{ route('Reviewer.web.job.allPosts') }}" class="btn btn-info">Reset</a>
        </div>
    </form>
            ...
            <tbody>
                ...
                <tr tabindex="0">
                    ...
                    <td data-label="Actions" class="action-buttons">
                        <a href="{{ route('Reviewer.web.job.edit', $job->id) }}" class="btn btn-info btn-sm" aria-label="Edit job {{ $job->title }}">Edit</a>

                        <form method="POST" action="{{ route('Reviewer.web.job.destroy', $job->id) }}" onsubmit="return confirm('Are you sure you want to delete this job post?');" style="display:inline;">
                            @csrf
                            @method('DELETE')
