...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 space-y-4 md:space-y-0">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('Reviewer.web.job.create') }}"
            ...
            <a href="{{ route('Reviewer.web.job.allPosts') }}"
                    ...
                    @foreach ($jobs as $job)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-center flex justify-center gap-2">
                                <a href="{{ route('Reviewer.web.job.edit', $job) }}"
                                ...
                                <form action="{{ route('Reviewer.web.job.destroy', $job) }}" method="POST"
            ...
            @foreach ($jobs as $job)
                <div class="bg-white rounded-lg shadow p-5 hover:shadow-lg transition transform hover:-translate-y-1">
                    ...
                    <div class="mt-4 flex flex-col sm:flex-row gap-2">
                        ...
                        <form action="{{ route('Reviewer.web.job.destroy', $job) }}" method="POST" class="flex-1"
                              onsubmit="return confirm('Are you sure?')">
                            @csrf @method('DELETE')
                            <button type="submit"
