...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <iframe id="contentFrame" src="{{ route('Student.profile-account.index') }}"></iframe>
    </div>
...
createNavButton('Browse Boards', 'fa-solid fa-layer-group', 'Boards', '{{ route("Student.home.boards") }}');


createNavButton('Saved','fa-solid fa-heart','Saved Papers','{{ route("Student.saved") }}');


createNavButton('My Profile','fa-solid fa-user-gear','My Profile','{{ route("Student.profile-account.index") }}');
