    ...
    <div class="mb-6 text-center">
        ...
        @if(request('search'))
            <div class="mt-4 flex items-center justify-center gap-4 flex-wrap">
                ...
                <a href="{{ route('Student.select.course', [$examBoard, $year, $session, $program]) }}"
                        ...
                        @if($firstResource)
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                @if(in_array($firstResource->id, $savedIds ?? []))
                                    ...
                                    <form action="{{ route('Student.home.resource.unsave', $firstResource) }}"
                                          method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                @else
                                    ...
                                    <form action="{{ route('Student.home.resource.save', $firstResource) }}"
                                          method="POST">
                                        @csrf
