...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <iframe id="contentFrame" src="{{  route('admin.profile-account.index') }}"></iframe>
    </div>
...
createNavButton('Analytics', 'fa-solid fa-chart-line', 'Analytics', '{{ route("admin.analytics.dashboard") }}');

createNavButton('Browse Boards', 'fa-solid fa-layer-group', 'Boards', '{{ route("admin.home.boards") }}');


createNavButton('Saved','fa-solid fa-heart','Saved Papers','{{ route("admin.saved") }}');

createNavButton('Register boards', 'fa-solid fa-school', 'Exam Boards', '{{ route("admin.setup.boards.index") }}');

createNavButton('Upload Resources', 'fa-solid fa-folder-open', 'Resources', '{{ route("admin.resources.index") }}');
...
// these are the web routes that let the user or admin change content on the website of this system
