...
<div class="p-8 min-h-screen bg-gradient-to-br from-zinc-950 via-slate-950 to-indigo-950 py-20 text-white">
    ...
    <div class="mb-6 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-300">
            {{ $examBoard->name }} → {{ $boardYear->year }} → Select Session
        </h1>
        ...
        @if(request('search'))
            <div class="mt-4 flex items-center justify-center gap-4 flex-wrap">
                ...
                <a href="{{ route('admin.resources.sessions.index', [$examBoard, $boardYear]) }}"
    ...
    <div class="mb-8">
        ...
        <div class="flex gap-3">
            ...
            <input
                ...
                placeholder="Search session (e.g. April/May, July/August)..."
    ...
    >
        ...
        @forelse($sessions as $session)
            ...
            <a href="{{ route('admin.resources.programs.index', [$examBoard, $boardYear, $session]) }}"
