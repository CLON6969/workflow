    ...
    <div class="w-full max-w-md">
        <div class="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8">
            ...
            <div class="flex flex-col items-center text-center mb-8">
                <i class="fas fa-edit text-5xl text-cyan-400 mb-4"></i>
                <h1 class="text-3xl font-bold tracking-tighter">Edit Board</h1>
            </div>
            ...
            <form method="POST" action="{{ route('admin.setup.boards.update', $examBoard) }}">
                @csrf
                @method('PUT')
