...
<div class="container mx-auto p-4">
    ...
    <a href="{{ route('admin.users.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Create New User</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    <a href="{{ route('admin.users.show', $user->id) }}" class="bg-gray-500 text-white px-2 py-1 rounded">View</a>
