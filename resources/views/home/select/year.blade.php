...
<div class="p-8 min-h-screen bg-gradient-to-br from-zinc-950 via-slate-950 to-indigo-950 py-20 text-white">
        ...
        <a href="{{ route('select.board', [$examBoard, $years]) }}"
    ...
    <div class="mb-6 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-300">
            {{ $examBoard->name }} → Select Year
        </h1>

        <p class="text-gray-400 mt-1">
            Total Years: {{ $years->total() }}
        </p>
        ...
        @if(request('search'))
            <div class="mt-4 flex items-center justify-center gap-4 flex-wrap">
                ...
                <p class="text-sm text-cyan-300">
                    Found {{ $years->total() }} result(s) for
                    "<span class="font-semibold">{{ request('search') }}</span>"
                </p>

                <a href="{{ route('select.year', $examBoard) }}"
    ...
    >
        ...
        @forelse($years as $year)
            ...
            <a href="{{ route('select.session', [$examBoard, $year]) }}"
               class="year-card bg-white border-4 border-gray-200 hover:border-blue-500 hover:shadow-lg transition duration-300 rounded-2xl p-5">
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="flex-1">
                        ...
                        <h2 class="year-name text-sm font-semibold text-gray-800 leading-relaxed">
                            {{ $year->year }}
                        </h2>
...
<div class="col-span-full text-center py-16 text-gray-400">
    ...
    <div class="bg-white/5 border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
        ...
        <p class="text-gray-300 mb-6 leading-relaxed">
            If the year/session you are looking for is not available,
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="https://wa.me/260976206889?text=Hello%2C%20I%20hope%20you%20are%20doing%20well.%0A%0AI%20was%20unable%20to%20find%20some%20years%20or%20sessions%20on%20your%20platform.%20Kindly%20assist%20me%20with%20adding%20or%20providing%20access%20to%20the%20missing%20year(s)%20or%20session(s).%0A%0AExamination%20Board%3A%20__________%0A%0AMissing%20Year(s)%20or%20Session(s)%3A%0A1.%20__________%0A2.%20__________%0A3.%20__________%20or%20ALL%0A%0AThank%20you."
               target="_blank"
...
// Live search
yearSearch.addEventListener('keyup', function () {
